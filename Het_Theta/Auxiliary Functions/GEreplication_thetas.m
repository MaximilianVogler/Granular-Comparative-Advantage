function [Y,YF,LF,mom,iter,time] = GEreplication_thetas(sigma,F,tau,RTS,RTL,ZHS,ZFS,ZHL,ZFL,w,wF,L,Y0,YF0,small,vMU,BER,paretonb,VEC_CD_THETA)
...
while diff>tol && iter<51
    % Solve PE
    [K,KF,~,~,LAMBDA,LAMBDAF,MU,MUF,LAMBDAFVEC,mom]=PEreplication_thetas(sigma,F,tau,RTS,RTL,ZHS,ZFS,ZHL,ZFL,w,wF,Y0,YF0,small,vMU,BER,paretonb,VEC_CD_THETA);
